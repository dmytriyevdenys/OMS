...
import { IProduct, IProductApiResponse, IProductForFrontend } from 'src/interfaces/product.interface';
...
export class ProductsApiService {
  ...
  async getAll(): Promise<IProductForFrontend[]> {
    ...
    const productsForFrontend:IProductForFrontend[] = products.map(product => (
        {
            id: product.id,
            name: product.name,
