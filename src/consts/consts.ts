export const PUBLIC_ROUTE_KEY = 'my_unique_public_route_key_123';
export const apiUrlCrm = 'https://openapi.keycrm.app/v1/';
export const API_URL_NOVAPOSHTA= 'https://api.novaposhta.ua/v2.0/json/';
